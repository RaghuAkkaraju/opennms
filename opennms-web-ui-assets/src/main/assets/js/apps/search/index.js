...
const angular = require('standalone/angular');
const kscTemplate = require('ngtemplate-loader!./template.ksc.html');
const nodesTemplate = require('ngtemplate-loader!./template.nodes.html');
const Util = require('standalone/util');
