...
(function() {
  ...
  const quickAddPanelBasicView = require('ngtemplate-loader!../../views/quick-add-panel-basic.html');
  const quickAddPanelSnmpView = require('ngtemplate-loader!../../views/quick-add-panel-snmp.html');
  const quickAddPanelCategoriesView = require('ngtemplate-loader!../../views/quick-add-panel-categories.html');
  const quickAddPanelCliView = require('ngtemplate-loader!../../views/quick-add-panel-cli.html');
  const quickAddPanelHelpView = require('ngtemplate-loader!../../views/quick-add-panel-help.html');
