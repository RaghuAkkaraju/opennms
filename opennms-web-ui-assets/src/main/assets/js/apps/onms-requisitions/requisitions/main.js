...
(function() {
  ...
  const requisitionsView = require('ngtemplate-loader!../lib/views/requisitions.html');
  const requisitionView = require('ngtemplate-loader!../lib/views/requisition.html');
  const foreignsourceView = require('ngtemplate-loader!../lib/views/foreignsource.html');
  const nodeView = require('ngtemplate-loader!../lib/views/node.html');
  const nodePanelsView = require('ngtemplate-loader!../lib/views/node-panels.html');
